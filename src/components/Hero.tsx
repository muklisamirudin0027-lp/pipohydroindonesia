...
export function Hero() {
  return (
    <section id="home" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      {/* Text Content */}
      <div className="relative z-10 flex w-full flex-col items-center px-6 text-center lg:px-20 pt-20">
        <motion.div
        ...
        >
          <div className="mb-8 flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-5 py-2 backdrop-blur-md">
          ...
          <h1 className="mb-6 max-w-4xl text-5xl font-light leading-[1.15] tracking-tight text-white md:text-6xl lg:text-7xl">
            Sayuran Segar, <br />
          ...
          <p className="mb-10 max-w-2xl text-base font-light leading-relaxed text-gray-300 md:text-lg">
      ...
      <motion.div 
        ...
        className="absolute bottom-8 z-20 hidden w-full max-w-6xl grid-cols-3 gap-6 px-6 lg:grid"
      >
        {[
