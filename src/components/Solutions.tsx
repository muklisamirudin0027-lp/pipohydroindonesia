...
export function Solutions() {
  ...
  return (
    <section id="solutions" className="bg-[#004D40] py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      {/* Background decorations */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] sm:w-[800px] sm:h-[800px] bg-[#008060]/20 rounded-full blur-3xl -mr-40 -mt-40 mix-blend-screen pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] sm:w-[600px] sm:h-[600px] bg-[#4ADE80]/10 rounded-full blur-3xl -ml-20 -mb-20 mix-blend-screen pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="mb-4 flex items-center justify-center gap-2 sm:gap-4">
            <span className="h-px w-6 sm:w-8 bg-[#4ADE80]"></span>
            <span className="text-[10px] sm:text-xs font-semibold tracking-[0.2em] text-[#4ADE80]">
              MENGAPA KAMI
            </span>
            <span className="h-px w-6 sm:w-8 bg-[#4ADE80]"></span>
          </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-3">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group flex flex-col items-center text-center p-6 sm:p-8 lg:p-10 border border-white/10 bg-white/5 backdrop-blur-md transition-all duration-500 hover:bg-white/10 hover:-translate-y-2 rounded-2xl"
            >
