...
export function Technology() {
  return (
    <section id="technology" className="bg-[#0b1c17] py-16 sm:py-24 lg:py-32 text-white">
        ...
        <div className="grid grid-cols-1 gap-12 sm:gap-16 lg:grid-cols-2 lg:items-center">
          ...
          >
            <div className="mb-4 flex items-center gap-4">
              ...
              <span className="text-[10px] sm:text-xs font-semibold tracking-[0.2em] text-[#D4AF37]">
                TEKNOLOGI KAMI
              </span>
            </div>
            <h2 className="mb-6 sm:mb-8 text-3xl font-light tracking-tight sm:text-4xl lg:text-5xl">
              Tumbuh dengan <br />
              <span className="font-semibold text-[#008060]">Presisi.</span>
            </h2>
            <p className="mb-8 sm:mb-12 text-base sm:text-lg font-light leading-relaxed text-gray-400">
          ...
          <motion.div
            ...
            className="relative aspect-[4/5] sm:aspect-square lg:aspect-[4/5] overflow-hidden bg-gray-900 group rounded-2xl mt-8 lg:mt-0"
          >
            <img
