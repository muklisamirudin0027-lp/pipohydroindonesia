      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-12">
          <motion.div
            ...
            className="lg:col-span-4 flex flex-col justify-between h-full bg-[#004D40] p-10 rounded-2xl text-white"
          >
            <div>
              <h3 className="mb-6 text-xl font-light tracking-wide">Lokasi Kebun Kami</h3>
          ...
          <motion.div
            ...
            className="lg:col-span-8 bg-[#FAFAFA] p-10 lg:p-12 border border-gray-100 shadow-sm rounded-2xl"
          >
